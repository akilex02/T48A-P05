...
Original file is located at
    https://colab.research.google.com/drive/1swV_tB6OQPDCACwjWosjZexXgb7GPtO1
...
# Datos
anios = np.array([2020, 2021, 2022, 2023, 2024])
precios = {
    "Model 3": np.array([39990, 41990, 43990, 45990, 47990]),
    "Model S": np.array([89990, 91990, 93990, 95990, 97990]),
    "Model X": np.array([99990, 101990, 103990, 105990, 107990]),
    "Model Y": np.array([44990, 46990, 48990, 50990, 52990])
}
...
def regresion_lineal_model_s():
  return calcular_regresion(anios, precios["Model S"])
  pass

def regresion_lineal_model_x():
  return calcular_regresion(anios, precios["Model X"])
  pass

def regresion_lineal_model_y():
  return calcular_regresion(anios, precios["Model Y"])
  pass

print("Model S", regresion_lineal_model_s())
print("Model X", regresion_lineal_model_x())
print("Model Y", regresion_lineal_model_y())
